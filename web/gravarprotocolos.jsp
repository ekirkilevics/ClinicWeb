...
<%
	//Configuração
	String tabela = "prot_protocolos";
	String chave = "cod_protocolo";
	String pagina = "protocolos.jsp";
	String ret = "";
	...
	String campos[] = {"", "protocolo", "cod_empresa"};
	String campostabela[] = {"cod_protocolo", "protocolo", "cod_empresa"};
		...
		if (!passou) {
			...
			if (acao.equals("inc")) {
				...
				if (ret.equals("OK")) {
					...
					if (lista != null) {
						...
						for (int i = 0; i < lista.length; i++) {
							...
							String aux2[] = {"cod_protocolo", "cod_bloco", "ordem"};
							out.println(banco.gravarDados("prot_bloco_protocolo", aux1, aux2, (String) session.getAttribute("usuario")));
						}
					}
				...
				if (ret.equals("OK")) {
					...
					banco.excluirTabela("prot_bloco_protocolo", "cod_protocolo", id, (String) session.getAttribute("usuario"));
