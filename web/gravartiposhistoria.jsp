...
<%
	//Configuração
	String tabela = "tiposhistoria";
	String chave = "cod_tipohistoria";
	String pagina = "tiposhistoria.jsp";
	String ret = "";
	...
	String campos[]       = {"","descricao","cor", "cod_empresa"};
    String campostabela[] = {"cod_tipohistoria","descricao", "cor", "cod_empresa"};
