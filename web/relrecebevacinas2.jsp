...
<body style="background-color:white">
	<form name="frmcadastrar" id="frmcadastrar" action="relrecebevacinas2.jsp" method="post">
	<!-- Campos ocultos -->
	...
	<br>
	<div class="texto"><b>Relatório de Recebimentos</b><br>Período de <%= de%> até <%= ate%></div>	
	<br>
	...
	<%
		if(de != null && ate != null) {
			Vector resp = vacina.getRelRecebeVacinas(de, ate, codcli, cod_vacina, cod_laboratorio, lote, ordem);
