...
<%
	//Configuração
	String tabela = "vac_prev_vacinas";
	String chave = "cod_prev_vacina";
	String pagina = "previsaovacinas.jsp";
	String ret = ""; //Retorno
	...
	String campos[]       = {"", "data_sugestao", "codcli", "dose", "cod_vacina"};
    String campostabela[] = {"cod_prev_vacina",  "data_sugestao", "cod_cliente", "dose", "cod_vacina"};
