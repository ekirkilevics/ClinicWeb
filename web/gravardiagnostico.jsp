...
<%
	//Configuração
	String tabela = "diagnosticos";
	String chave = "cod_diag";
	String pagina = "diagnosticos.jsp";
	String ret = "";
	...
	String campos[]       = {"","cid","descricao","flag","cod_empresa"};
    String campostabela[] = {"cod_diag","CID","DESCRICAO","flag", "cod_empresa"};
