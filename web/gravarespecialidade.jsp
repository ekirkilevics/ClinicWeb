...
<%
	//Configuração
	String tabela = "especialidade";
	String chave = "codesp";
	String pagina = "especialidades.jsp";
	String ret = "";
	...
	String campos[]       = {"","profissao","especialidade","cod_empresa"};
    String campostabela[] = {"codesp","cod_profis","descri", "cod_empresa"};
