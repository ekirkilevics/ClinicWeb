...
<%
	//Configuração
	String tabela = "vac_laboratorios";
	String chave = "cod_laboratorio";
	String pagina = "laboratorios.jsp";
	String ret = ""; //Retorno
	...
	String campos[]       = {"","laboratorio", "endereco", "telefone", "contato", "ativo", "cod_empresa"};
    String campostabela[] = {"cod_laboratorio","laboratorio", "endereco", "telefone", "contato", "ativo", "cod_empresa"};
