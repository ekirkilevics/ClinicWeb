...
<%
	//Configuração
	String tabela = "indicacoes";
	String chave = "cod_indicacao";
	String pagina = "indicacoes.jsp";
	String ret = ""; //Retorno
	...
	String campos[]       = {"","indicacao","cod_empresa"};
    String campostabela[] = {"cod_indicacao","indicacao","cod_empresa"};
