...
<%
	//Configuração
	String tabela = "grupoprocedimento";
	String chave = "cod_grupoproced";
	String pagina = "grupoproced.jsp";
	String ret = "";
	...
	String campos[]       = {"","grupoproced", "cor", "cod_empresa"};
    String campostabela[] = {"cod_grupoproced","grupoproced", "cor", "cod_empresa"};
