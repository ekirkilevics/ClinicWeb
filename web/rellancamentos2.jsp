...
<%			
	 ...
	 *  filtros[7] = Grupo de Procedimento
	*/
	...
	filtros[7] = !Util.isNull(request.getParameter("grupoproced")) ? request.getParameter("grupoproced") : "todos";
	...
	if(agrupar.equals("faturas.Data_Lanca")) nome_relatorio = "Relatório por Data";
...
<body style="background-color:white">
	...
	<%
		if(de != null && ate != null) {
			Vector resp = relatorio.getLancamentos(de, ate, agrupar, filtros, primeiravez);
