...
<form name="frmcadastrar" id="frmcadastrar" action="relentradasaida2.jsp" target="_blank" method="post" onSubmit="return validaForm()">
  <table width="600" border="0" align="center" cellpadding="2" cellspacing="0">
    <tr>
      <td height="18" class="title">.: Relatório de Atendimentos :.</td>
    </tr>
      ...
      <td>
         <table width="300" border="0" cellpadding="0" cellspacing="0" class="table">
			...
			<tr>
				...
				<td class="tdLight" nowrap colspan="3"> 
					<input type="hidden" name="codcli" id="codcli">			
					<input style="width:98%" class="caixa" type="text" name="nome" id="nome" onKeyUp="busca(this.value, 'codcli', 'nome','paciente')">
			...
			<tr>
				<td colspan="2" class="tdMedium">Procedente:</td>
				<td colspan="2" class="tdMedium">Encaminhado:</td>
			</tr>
			<tr>
				<td colspan="2" class="tdLight">
						<select name="procedente" id="procedente" class="caixa" style="width:150px; height:150px" multiple>
							<%= atendimento.getEntradasSaidas("P", cod_empresa) %>
						</select>
				</td>
				<td colspan="2" class="tdLight">
					<select name="encaminhado" id="encaminhado" class="caixa" style="width:150px; height:150px" multiple>
						<%= atendimento.getEntradasSaidas("E", cod_empresa) %>
					</select>
				</td>
			</tr>
			<tr>
				<td class="tdMedium">Período: entre</td>
				<td class="tdLight"><input type="text" name="hora1" id="hora1" class="caixa" size="5" maxlength="3" onkeypress="Javascript:OnlyNumbersSemPonto(this,event);"> h</td>
				<td class="tdMedium">até</td>
            	<td class="tdLight"><input type="text" name="hora2" id="hora2" class="caixa" size="5" maxlength="3" onKeyPress="Javascript:OnlyNumbersSemPonto(this,event);"> h</td>
			</tr>
			<tr>
