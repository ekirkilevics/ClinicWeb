...
<%
	//Configuração
	String tabela = "exames";
	String chave = "cod_exame";
	String pagina = "exames.jsp";
	String ret = "";
	...
	String campos[]       = {"","exame", "unidade", "ativo", "minimo", "maximo", "cod_empresa"};
    String campostabela[] = {"cod_exame","exame", "unidade", "ativo", "minimo", "maximo", "cod_empresa"};
