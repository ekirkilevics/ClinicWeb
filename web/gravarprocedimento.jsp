...
<%
	//Configuração
	String tabela = "procedimentos";
	String chave = "COD_PROCED";
	String pagina = "procedimentos.jsp";
	String ret = "";
	...
	String campos[]       = {"","codigo","procedimento","flag","laudo","grupoproced","codesp", "tipoGuia", "cod_empresa"};
    String campostabela[] = {"COD_PROCED","CODIGO","Procedimento","flag","laudo","grupoproced","codesp", "tipoGuia", "cod_empresa"};
	...
	else
	{
		...
		if(ret.equals("OK"))
		{
			//Excluir também os valores para esses procedimentos
			banco.excluirTabela("valorprocedimentos", "cod_proced", id, (String)session.getAttribute("usuario"));
