...
<script language="JavaScript">
	 ...
	 var page = "gravarfaturamento2.jsp";
	 //Cod. da ajuda
	 cod_ajuda = 8;
	...
	function gerarGuia(codFatura) {
		var jsqtdeitens = cbeGetElementById("qtdeitens").value;
		
		//Se não inseriu nenhum item no faturamento, não gerar guia
		if(jsqtdeitens == "0") {
			alert("Insira pelo menos um procedimento para emitir a Guia do TISS");
			return;
		}
		else {
...
<form name="frmcadastrar" id="frmcadastrar" action="faturamentos.jsp?cod=<%= strcod%>" method="post">
  <table width="600" border="0" align="center" cellpadding="2" cellspacing="0">
				...
				<td colspan="5" width="100%">
					<table width='100%' border='0' cellpadding='0' cellspacing='0'>
						...
						<tr>
							...
							<%= faturamento.getItensFatura(strcod) %>
						<tr>
							<td colspan='4' class='tdMedium' style='text-align:right'>Total=></td>
							<td colspan="3" class='tdMedium'>
	...
	<%= Util.getBotoes("faturamentos", pesq, tipo) %>
	<tr>
		<td>&nbsp;</td>
	</tr>
    <tr>
		<td width="100%" align="center">
			<table width="600px">
				<tr>
					<td class="tdDark"><a title="Ordenar por Paciente" href="Javascript:ordenar('faturamentos','paciente.nome')">Paciente</a></td>
					<td width="115" class="tdDark"><a title="Ordenar por Executante" href="Javascript:ordenar('faturamentos','Executante.nome')">Executante</a></td>
					<td width="112" class="tdDark"><a title="Ordenar por Solicitante" href="Javascript:ordenar('faturamentos','Solicitante.nome')">Solicitante</a></td>
					<td width="65" class="tdDark"><a title="Ordenar por Data Decrescente" href="Javascript:ordenar('faturamentos','data_Lanca DESC')">Data</a></td>
