...
<script language="JavaScript">
	 ...
	 var inf = "<%= inf%>";
	 //Nome dos campos
	 var nome_campos_obrigatorios = Array("Descrição");
	...
	function clickBotaoExcluir() {
		if(jsaplicado == "S") {
			alert("Protocolo não pode ser excluído pois já foi aplicado em um protocolo");
		}
		else {
			enviarAcao('exc');
		}
  ...
  <table width="600" border="0" align="center" cellpadding="2" cellspacing="0">
    ...
    <tr>
		<td width="100%" style="text-align:center">
			<table width="600px">
				<tr>
					<td width="100%" class="tdDark">Questionários</td>
				</tr>
			</table>
