...
<form name="frmcadastrar" id="frmcadastrar" action="relprevvacinas2.jsp" target="_blank" method="post" onSubmit="return validaForm()">
  <table width="600" border="0" align="center" cellpadding="2" cellspacing="0">
    <tr>
      <td height="18" class="title">.: Relatório de Previs&atilde;o de Vacinas :.</td>
    </tr>
