...
<%
	//Configuração
	String tabela = "link_assuntos";
	String chave = "cod_assunto";
	String pagina = "linkassuntos.jsp";
	String ret = "";
	...
	String campos[]       = {"","assunto","cod_empresa"};
    String campostabela[] = {"cod_assunto","assunto", "cod_empresa"};
