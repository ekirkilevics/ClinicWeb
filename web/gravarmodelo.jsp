...
<%
	//Configuração
	String tabela = "modelos";
	String chave = "cod_modelo";
	String pagina = "modelos.jsp";
	String ret = "";
	...
	String campos[]       = {"","descricao","texto","tipomodelo", "cod_empresa"};
    String campostabela[] = {"cod_modelo","descricao","modelo","tipomodelo","cod_empresa"};
