...
<%
	//Configuração
	String tabela = "profissao";
	String chave = "cod_profis";
	String pagina = "profissoes.jsp";
	String ret = "";
	...
	String campos[]       = {"","profissao","registro","codCBOS", "cod_empresa"};
    String campostabela[] = {"cod_profis","nome", "tipo_registro", "codCBOS", "cod_empresa"};
