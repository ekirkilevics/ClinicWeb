...
<form name="frmcadastrar" id="frmcadastrar" action="relresumovacinas2.jsp" target="_blank" method="post" onSubmit="return validaForm()">
  <table width="600" border="0" align="center" cellpadding="2" cellspacing="0">
    <tr>
      <td height="18" class="title">.: Relatório de Resumo de Faturas em Vacinas :.</td>
    </tr>
      ...
      <td>
         <table width="300" border="0" cellpadding="0" cellspacing="0" class="table">
			...
			<tr>
				...
				<td class="tdLight"><input type="text" name="de" id="de" class="caixa" size="12" maxlength="10" onKeyPress="return formatar(this, event, '##/##/####');" value="<%= Util.getData()%>"></td>
