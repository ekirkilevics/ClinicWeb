...
<form name="frmcadastrar" id="frmcadastrar" action="agconsultapresencial2.jsp" target="iframeagenda" method="post">
  <table width="600" border="0" align="center" cellpadding="2" cellspacing="0">
    <tr>
      <td height="18" class="title">.: Relatório de Agendamento Presencial :.</td>
    </tr>
...
<center>
	<iframe name="iframeagenda" id="iframeagenda" width="95%" height="100%" scrolling="auto" frameborder="0"></iframe>
</center>
</body>
</html>
