/* Arquivo: Profissao.java
 * Autor: Amilton Souza Martha
 * Criação: 08/09/2005   Atualização: 22/06/2006
 * Obs: Manipula informações de profissão
 */
...
public class Profissao {
    ...
    public Profissao() {
        ...
        */
    public String[] getProfissoes(String pesquisa, String campo, String ordem, int numPag, int qtdeporpagina, int tipo, String cod_empresa) {
        String resp[] = {"",""};
        String sql = "";
        String paginacao = "";
        ResultSet rs = null;
        ...
        try {
            ...
            resp[1] = Util.criaPaginacao("profissoes.jsp", numPag, qtdeporpagina, numRows);
            ...
            while(rs.next()) {
                resp[0] += "<tr onClick=go('profissoes.jsp?cod=" + rs.getString("cod_profis") + "') onMouseOver='trocaCor(this,1);' onMouseOut='trocaCor(this,2);'>";
